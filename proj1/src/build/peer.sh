...
java -XX:+UnlockExperimentalVMOptions -XX:+UseEpsilonGC -XX:+AlwaysPreTouch -Xms2G -Xmx2G -Djava.rmi.server.codebase=sdis/t1g06/ -Djava.security.manager -Djava.security.policy=../rmipolicy/my.policy/ sdis.t1g06.Peer ${ver} ${id} ${sap} ${mc_addr} ${mc_port} ${mdb_addr} ${mdb_port} ${mdr_addr} ${mdr_port}
